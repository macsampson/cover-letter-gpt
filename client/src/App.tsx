  ...
  return (
    <main>
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            <p>
              ...
              GPT-powered cover letter generator. Simply attach your resume,
              enter a job description, and let it create a cover letter for you.
            </p>
            <br></br>
            <p
              style={{
        ...
        <InputAlert open={state.alert} onAlertClose={handleAlertClose} />
